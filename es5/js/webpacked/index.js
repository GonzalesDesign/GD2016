...
/******/return __webpack_require__(0);/******/})(/************************************************************************//******/[/* 0 *//***/function(module,exports,__webpack_require__){__webpack_require__(1);__webpack_require__(1);module.exports=__webpack_require__(6);/***/},/* 1 *//***/function(module,exports,__webpack_require__){/***********************************************
...
/**----------=====| anim |=====----------**/var anim=__webpack_require__(4);/**----------=====| twoKolumns |=====----------**/var twoKolumns=__webpack_require__(5);//ANIMATION TIME
...
"use strict";/**-----------=====| IMPORT | REQUIRE |=====-----------**//** DESCRIPTIONS:
	   ** FILES IMPORTED FROM OTHER JS FILES
	   ** SEPERATE JS FILES FOR EASIER READABILITY AND MAINTENANCE
	   **----------------------------------------------------------------**/var anim=__webpack_require__(4);//let TwoColumnsClass = require('./codeArchitecture_X'); //.TwoColumnsClass;
...
/**----------------------------------------------------------------**/console.log("\n\t   Filename: nextPreviousArrows.js\n\t   Exports: module.exports.NextPrevNavClass = NextPrevNavClass ");/**----------------------------------------------------------------**/})();/***/},/* 4 *//***/function(module,exports){/**----------===| Created by Odee on 5/18/16.|===----------**/(function(){//IIFE:Immediately-Invoked Function Expression. Scope Encapsulation
...
/**----------------------------------------------------------------**/console.log("\n\t  Filename: animationFunctions.js\n\t  module.exports.fXSlider = fXSlider\n\t  ");/**----------------------------------------------------------------**/})();/***/},/* 5 *//***/function(module,exports,__webpack_require__){/**----------===| Created by Odee on 06/17/16.|===----------**/(function(){//IIFE:Immediately-Invoked Function Expression
"use strict";console.log("Filename: twoColumns.js");var anim=__webpack_require__(4);/**----------=====| fRoundToTwo Function |=====----------**//** Description:
	   ** fRoundToTwo: rounds the decimals to two.
...
//let titleNameId     = $ ("#" + title + "Id_" + counter); //get id
$(this.titleName).appendTo(appendedTo);//fDivStyle(divClass, divHeight, divWidth, divOverflow, "grey");
}}]);return CreateBasicElement;}();var BasicTextContent=function(_CreateBasicElement2){_inherits(BasicTextContent,_CreateBasicElement2);function BasicTextContent(){_classCallCheck(this,BasicTextContent);return _possibleConstructorReturn(this,Object.getPrototypeOf(BasicTextContent).call(this));}_createClass(BasicTextContent,[{key:"fBasicTextContent",value:function fBasicTextContent(titleId,counter,titleClass,appendedTo,textString){_get(Object.getPrototypeOf(BasicTextContent.prototype),"fCreateBasicElement",this).call(this,titleId,counter,titleClass,appendedTo);this.titleName.innerHTML=textString;}}]);return BasicTextContent;}(CreateBasicElement);/**------------=====| fBasicDivStyle CSS |=====------------*, "relative"*/var fBasicDivStyle=function fBasicDivStyle(divName,divHeight,divWidth,divPosition){//console.log("divName: ", divName);
divName.css({"width":divWidth,"height":divHeight,"position":divPosition,//relative absolute
"float":"left"//"overflow": divOverflow, //hidden; visible
//"border": "0px solid red" //+ borderColor
//"border-bottom" : "10px solid",
...
var imageBasicDiv=new CreateBasicElement();/**------------=====| End CreateBasicElement Class |=====------------**//**----------=====| ProjectDiv Class |=====----------**//** Description:
			 ** ProjectDiv class template is an extension of the CreateElementDiv class.
			 ** For creating project container divs.
			 ***********************/var ProjectDiv=function(_CreateElementDiv5){_inherits(ProjectDiv,_CreateElementDiv5);function ProjectDiv(){_classCallCheck(this,ProjectDiv);return _possibleConstructorReturn(this,Object.getPrototypeOf(ProjectDiv).call(this));}_createClass(ProjectDiv,[{key:"fCreateProjDiv",value:function fCreateProjDiv(title,counter,appendedTo,divHeight,divWidth,divOverflow){_get(Object.getPrototypeOf(ProjectDiv.prototype),"fCreateDiv",this).call(this,title,counter,appendedTo);var divClass=$("."+title+"Class");//get class
fDivStyle(divClass,divHeight,divWidth,divOverflow,"grey");}}]);return ProjectDiv;}(CreateElementDiv);/**----------=====| ColumnDiv Class |=====----------**//** Description:
			 ** ColumnDiv class template is an extension of the CreateElementDiv class.
			 ** For creating column divs.
			 ***********************/var ColumnDiv=function(_CreateElementDiv6){_inherits(ColumnDiv,_CreateElementDiv6);function ColumnDiv(){_classCallCheck(this,ColumnDiv);return _possibleConstructorReturn(this,Object.getPrototypeOf(ColumnDiv).call(this));}_createClass(ColumnDiv,[{key:"fCreateColumnDiv",value:function fCreateColumnDiv(title,counter,appendedTo,divHeight,divWidth,divOverflow){_get(Object.getPrototypeOf(ColumnDiv.prototype),"fCreateDiv",this).call(this,title,counter,appendedTo);var divClass=$("."+title+"Class");//get class
var divNameId=$("#"+title+counter);//get id
fDivStyle(divNameId,divHeight,divWidth,divOverflow,"black");//DELETE COLOR
//divClass.css({"height": "250px"}); //testing
}}]);return ColumnDiv;}(CreateElementDiv);/**----------=====| ImgDiv Class |=====----------**//** Description:
			 ...
			 ** of the CreateElementDiv class.
			 ** For creating image divs.
			 **----------------------------------------------**/var ImgDiv=function(_CreateElementDiv7){_inherits(ImgDiv,_CreateElementDiv7);function ImgDiv(){_classCallCheck(this,ImgDiv);return _possibleConstructorReturn(this,Object.getPrototypeOf(ImgDiv).call(this));}_createClass(ImgDiv,[{key:"fCreateImgDiv",value:function fCreateImgDiv(title,counter,appendedTo,imgSrc,divHeight,divWidth,divOverflow){_get(Object.getPrototypeOf(ImgDiv.prototype),"fCreateDiv",this).call(this,title,counter,appendedTo);//let divClass = $ ("." + title + "Class"); //get class
/** getting the div id name has to follow the same convention
					 ** as it was set on the parent class.
					 ** this.divName.id        = title + "Id_" + counter; //set id name
					 ** let divNameId = $ ("#" + title + "Id_" + counter); //get id name
...
fImgDivStyle(divNameId,imgSrc,divHeight,divWidth,divOverflow);}}]);return ImgDiv;}(CreateElementDiv);/**----------=====| TextContent Class |=====----------**//** Description:
			 ** TextContent class template is an extension
			 ** of the CreateElementDiv class.
			 ** For creating innerHTML divs. ************//**------------**/var TextContent=function(_CreateElementDiv8){_inherits(TextContent,_CreateElementDiv8);function TextContent(){_classCallCheck(this,TextContent);return _possibleConstructorReturn(this,Object.getPrototypeOf(TextContent).call(this));}_createClass(TextContent,[{key:"fCreateSimpleTextDiv",value:function fCreateSimpleTextDiv(name,counter,appendedTo,textString){_get(Object.getPrototypeOf(TextContent.prototype),"fCreateDiv",this).call(this,name,counter,appendedTo);this.divName.innerHTML=textString;}},{key:"fCreateTextDiv",value:function fCreateTextDiv(name,counter,nameClass,appendedTo,textString,titleString){_get(Object.getPrototypeOf(TextContent.prototype),"fCreateDiv",this).call(this,name,counter,appendedTo);//this.nameName = document.createElement("div");
//this.nameName.id = nameId + counter; //set id // name + "Id_" + counter;
this.divName.className=nameClass;//set className
//let nameNameId     = $ ("#" + name + "Id_" + counter); //get id
//$(this.nameName).appendTo(appendedTo);
...
// `);
var codingThisSiteId=void 0;var logoContainerDivId=void 0;var logoLeftColDivId=void 0;var logoRightColDivId=void 0;var logoTitleColumnPercent=void 0;var logoTitleClass=void 0;var logoSubTitleClass=void 0;var logoTitleId=void 0;var logoSubTitleId=void 0;var introCalloutId=void 0;var toggleBtn=void 0;//let codingThisSiteId;
var introImageIds=void 0;var myIntroImage=void 0;var introBackgroungImage=void 0;var rightColumnHeight=void 0;var randColorTheme=void 0;var fIntroAjax=function fIntroAjax(){var promise=$.get("./js/json/introImages.json");promise.then(function(data){var jx=0;var _iteratorNormalCompletion5=true;var _didIteratorError5=false;var _iteratorError5=undefined;try{for(var _iterator5=data.GDSiteIntro[Symbol.iterator](),_step5;!(_iteratorNormalCompletion5=(_step5=_iterator5.next()).done);_iteratorNormalCompletion5=true){var introData=_step5.value;/**----------===| CREATE CODING CONTAINER DIV INSIDE INTROCONTAINER |===----------**/createDiv.fCreateBasicElement(introData.title+"_CodingContainer",jx,"codingContainer",introContainer);var codingContainerId=$("#"+introData.title+"_CodingContainer"+jx);//GET ID
/**----------===| CREATE CODING TEXT DIV INSIDE CODINGCONTAINER |===----------**/createDiv.fCreateBasicElement(introData.title+"_CodingThisSite",jx,"codingThisSite",codingContainerId);codingThisSiteId=$("#"+introData.title+"_CodingThisSite"+jx);//GET ID
var codingThisSite=$(".codingThisSite");//GET CLASSNAME
var codingThisSiteHeight=codingThisSiteId.height();fBasicDivStyle(codingThisSiteId,"auto",gdContainerWidth,"absolute");//CSS
var centerOnScreenY=inWindowHeight/2-codingThisSiteHeight/2;codingThisSiteId.css({"margin-top":centerOnScreenY});/**----------===| CREATE CODING PARAGRAPHS |===----------**/textDiv.fCreateTextDiv("codingTitle",jx,"codingTitleClass",codingThisSiteId,introData.codingTitle);textDiv.fCreateTextDiv("codingDescription",jx,"codingDescriptionClass",codingThisSiteId,introData.codingThisSite);/**----------===| CREATE LOGO CONTAINER DIV INSIDE INTROCONTAINER DIV |===----------**/createDiv.fCreateBasicElement(introData.title+"_LogoContainer",jx,"logoContainer",introContainer);logoContainerDivId=$("#"+introData.title+"_LogoContainer"+jx);//GET ID
...
// let inWindowWidth = window.innerWidth;
// let inWindowHeight = window.innerHeight;
fIntroImageStyle(introImageIds,inWindowHeight,inWindowWidth,myIntroImage.src);}}catch(err){_didIteratorError5=true;_iteratorError5=err;}finally{try{if(!_iteratorNormalCompletion5&&_iterator5.return){_iterator5.return();}}finally{if(_didIteratorError5){throw _iteratorError5;}}}});};/**----------===| INVOKE FUNCTION |===----------**///fIntroAjax();
//let logoContainer = $(".logoContainer");
// function toggleClass() {
//   //$("." + divClass).toggle();
//   logoContainer.toggle();
...
//   fWindowOpen2(personalFreshLinkId, personalFreshLink);
//TEMP fScreenQueries();
var _iteratorNormalCompletion6=true;var _didIteratorError6=false;var _iteratorError6=undefined;try{for(var _iterator6=data.GDSite[Symbol.iterator](),_step6;!(_iteratorNormalCompletion6=(_step6=_iterator6.next()).done);_iteratorNormalCompletion6=true){var sect=_step6.value;j1++;console.log("Section j1: "+j1+" "+sect.title);// /**----------===| LINKS TO OPEM TO ANOTHER WINDOW |===----------**/
// let nycBikeFlashSample = $('#nycBikeFlashSample');
// fRollEvents(nycBikeFlashSample, "white");
//
// let akonFlashSample = $('#akonFlashSample');
...
// fWindowOpen2(akonFlashSample, "http://www.rlgonzales.com/Scroll/images/ANIMATIONS/Flash/Akon/");
aSectionsCount[aSectionsCount.length]=sect;//PUSH
/**----------===| INVOKE SECTION COLUMNS |===----------**/twoColumnsHeaderSection.fTwoColumnsQueries(gdContainerWidth,sect.headerRightColumnPercent,arbitraryNum,arbitraryNum);aSectionsRightColumnPercent[aSectionsRightColumnPercent.length]=sect.headerRightColumnPercent;/**----------===| CREATE SECTION HEADER CONTAINER |===----------------------------------------**/createDiv.fCreateBasicElement(sect.title,j1,"sectionHeaderClass",gdContainer);var sectDivIds=$("#"+sect.title+j1);fBasicDivStyle(sectDivIds,"auto",gdContainerWidth,"relative");aSectionHeaders[aSectionHeaders.length]=sectDivIds;/**----------===| CREATE SECTION HEADER DIVIDER |===----------------------------------------**/createDiv.fCreateBasicElement("sectDivider",j1,"sectionDividerClass",sectDivIds);var sectDividerIds=$("#"+"sectDivider"+j1);/**----------===| COLOR THEME: DIVIDER |===----------**/sectDividerIds.css({"background-color":randColorTheme});/**----------===| CREATE HEADER LEFT COLUMN |===------------------------------------------------------------**/createDiv.fCreateBasicElement(sect.title+"_Left",j1,"sectionHeaderLeftColmnClass",sectDivIds);var sectLeftIds=$("#"+sect.title+"_Left"+j1);fBasicDivStyle(sectLeftIds,arbitraryNum,twoColumnsHeaderSection.LeftColumn,"relative");aSectionHeadrLeftColmn[aSectionHeadrLeftColmn.length]=sectLeftIds;/**----------===| CREATE HEADER RIGHT COLUMN |===-------------------------------------------------------------**/createDiv.fCreateBasicElement(sect.title+"_Right",j1,"sectionHeaderRightColmnClass",sectDivIds);var sectRightIds=$("#"+sect.title+"_Right"+j1);fBasicDivStyle(sectRightIds,"auto",twoColumnsHeaderSection.RightColumn,"relative");aSectionHeadrRightColmn[aSectionHeadrRightColmn.length]=sectRightIds;/**----------===| Sections Header Title Text |===----------**/sectionHeaderText.fBasicTextContent(sect.title+"_Text",j1,"sectionHeaderTxtContentClass",sectRightIds,sect.sectionTitle);var sectionTitleIds=$("#"+sect.title+"_Text"+j1);fBasicDivStyle(sectionTitleIds,"auto",twoColumnsHeaderSection.RightColumn,"relative");headerText.fTextQueries(gdContainerWidth,sectionTitleIds,headerSmlFontSize,headerMidFontSize,headerLrgFontSize);aSectionHeadrTitles[aSectionHeadrTitles.length]=sectionTitleIds;var _iteratorNormalCompletion7=true;var _didIteratorError7=false;var _iteratorError7=undefined;try{for(var _iterator7=sect.projects[Symbol.iterator](),_step7;!(_iteratorNormalCompletion7=(_step7=_iterator7.next()).done);_iteratorNormalCompletion7=true){var proj=_step7.value;j2++;console.log("\n\t\t              Project j2: "+j2+" "+proj.title);/**----------===| Divider tag for DOM and style inspection in the browser dev view for testing |===----------**/tagElement.fCreateTag("i","Divider:-------------------====•",proj.title,j2,gdContainer);/**----------===| PUSH TO ARRAY: PROJECT COUNT |===----------**/aProjectsCount[aProjectsCount.length]=proj;/**----------===| INVOKE PROJECT COLUMNS |===----------**/twoColumnsImgProjects.fTwoColumnsQueries(gdContainerWidth,proj.imgRightColumnPercent,proj.imagesWidth,proj.imagesHeight);/**----------===| PUSH TO ARRAY: PROJECT RIGHT COLUMNS |===----------**/aProjectRightColumnPercent[aProjectRightColumnPercent.length]=proj.imgRightColumnPercent;aImagesOrigWidth[aImagesOrigWidth.length]=proj.imagesWidth;aImagesOrigHeight[aImagesOrigHeight.length]=proj.imagesHeight;/**----------===| CREATE PROJECT IMAGE CONTAINER |===----------**/createDiv.fCreateBasicElement(proj.title+"_ProjContainer",j2,"projectContainerClass",gdContainer);/**----------===| Project Container Ids |===----------**/var projContainerIds=$("#"+proj.title+"_ProjContainer"+j2);/**p----------===| Project Container: Basic Style |===----------**/fBasicDivStyle(projContainerIds,"auto",gdContainerWidth);// ID, HEIGHT, WID, "relative"TH
/**----------===| push to array use for animation |===----------**/aProjContainerIds[aProjContainerIds.length]=projContainerIds;/**----------===| CREATE PROJECT IMAGE CONTAINER: LEFT COLUMN |===----------**/createDiv.fCreateBasicElement(proj.title+"_Left",j2,"projectLeftColmnClass",projContainerIds);/**----------===| Left Column Ids |===----------**/var projContainrLeftColDivIds=$("#"+proj.title+"_Left"+j2);/**p----------===| Left Column: Basic Style |===----------**/fBasicDivStyle(projContainrLeftColDivIds,arbitraryNum,twoColumnsImgProjects.LeftColumn);// other css properties: ".projectLeftColmnClass" in css fil, "relative"e.
/**----------===| push to array |===----------**/aProjLeftColDivIds[aProjLeftColDivIds.length]=projContainrLeftColDivIds;/**----------===| CREATE PROJECT IMAGE CONTAINER: RIGHT COLUMN |===----------**//** function parameters:(Id, Class, appendTo)
								 **--------------------------------------------------------------------**/createDiv.fCreateBasicElement(proj.title+"_ProjRight",j2,"projectRightColmnClass",projContainerIds);/**----------===| Right Column: Ids |===----------**/var projRightColDivIds=$("#"+proj.title+"_ProjRight"+j2);/**----------===| Right Column: Basic CSS |===----------------------------------**/fBasicDivStyle(projRightColDivIds,twoColumnsImgProjects.NewHeight+additionalHeight,twoColumnsImgProjects.RightColumn,"relative");aProjRightColDivIds[aProjRightColDivIds.length]=projRightColDivIds;//push
aProjectDisplay[aProjectDisplay.length]=proj.displayType;//push
...
// /**|===============================|**/
// `);
var _iteratorNormalCompletion8=true;var _didIteratorError8=false;var _iteratorError8=undefined;try{for(var _iterator8=proj.images[Symbol.iterator](),_step8;!(_iteratorNormalCompletion8=(_step8=_iterator8.next()).done);_iteratorNormalCompletion8=true){var imgs=_step8.value;j3++;// console.log(`
//   <•----------------------------------•>
//   aImagesCount.length:j3 :  ${aImagesCount.length}
//   ${imgs.imgTitle}
//   <•----------------------------------•>
...
// this.ImgContainerWidth; // = imgContainerWidth;
// this.fluidContainerWidth = fluidContainerWidth;
}_createClass(NextPrevNavClass,[{key:"fNextPrevNavigation",value:function fNextPrevNavigation(rightArrow,leftArrow,imgContainer,imgContainerWidth,fluidContainerWidth){var _this12=this;//}, rightColumnPercentage, imgOrigWidth, imgOrigHeight) {
this.String="Hello from fNextPreviousTwoColumnsClass method";this.RightArrow=rightArrow;this.LeftArrow=leftArrow;this.ImgContainer=imgContainer;this.ImgContainerWidth=imgContainerWidth;this.fluidContainerWidth=fluidContainerWidth;this.Num=0;var num=0;var containerXPos=0;this.fluidContainerLeftPosition=0;var fluidContainerLeftPosition=void 0;/**-----------=====| Next button function |=====-----------**/rightArrow.click(function(){num++;_this12.Num=num;containerXPos=_this12.ImgContainerWidth*num;leftArrow.show();// console.log(`
//     np:${imgContainer}-----------------------------------------
//     image width:                    ${this.ImgContainerWidth}
//     multiplied by numbr of clicks:  ${num}
//                                     ------------------
...
//     this.Num: same as clicks        ${this.Num}
//     np:---------------------------------------------------`)
/**-----| If the current x position greater or equals to the fluid-container width |-----**/_this12.fluidContainerLeftPosition=_this12.fluidContainerWidth-_this12.ImgContainerWidth*2;if(containerXPos>=_this12.fluidContainerLeftPosition){rightArrow.hide();}/**-----| fXSlider: Slides the image container to the left |-----**/anim.fXSlider(imgContainer,-containerXPos);//console.log(rightArrow, num, ":np---------------------------------------------------");
});/**-----------=====| Previous button function |=====-----------**/leftArrow.click(function(){num--;_this12.Num=num;containerXPos=_this12.ImgContainerWidth*num;rightArrow.show();// console.log(`
//     image width:                    ${this.ImgContainerWidth}
//     multiplied by numbr of clicks:  ${num}
//                                     ------------------
//     container x position:           ${containerXPos}
...
//let titleNameId     = $ ("#" + title + "Id_" + counter); //get id
$(this.titleName).appendTo(appendedTo);//fDivStyle(divClass, divHeight, divWidth, divOverflow, "grey");
}}]);return CreateBasicElement;}();var BasicTextContent=function(_CreateBasicElement3){_inherits(BasicTextContent,_CreateBasicElement3);function BasicTextContent(){_classCallCheck(this,BasicTextContent);return _possibleConstructorReturn(this,Object.getPrototypeOf(BasicTextContent).call(this));}_createClass(BasicTextContent,[{key:"fBasicTextContent",value:function fBasicTextContent(titleId,counter,titleClass,appendedTo,textString){_get(Object.getPrototypeOf(BasicTextContent.prototype),"fCreateBasicElement",this).call(this,titleId,counter,titleClass,appendedTo);this.titleName.innerHTML=textString;}}]);return BasicTextContent;}(CreateBasicElement);/**------------=====| fBasicDivStyle CSS |=====------------*, "relative"*/var fBasicDivStyle=function fBasicDivStyle(divName,divHeight,divWidth,divPosition){//console.log("divName: ", divName);
divName.css({"width":divWidth,"height":divHeight,"position":divPosition,//relative absolute
"float":"left"//"overflow": divOverflow, //hidden; visible
//"border": "0px solid red" //+ borderColor
//"border-bottom" : "10px solid",
...
var imageBasicDiv=new CreateBasicElement();/**------------=====| End CreateBasicElement Class |=====------------**//**----------=====| ProjectDiv Class |=====----------**//** Description:
				 ** ProjectDiv class template is an extension of the CreateElementDiv class.
				 ** For creating project container divs.
				 ***********************/var ProjectDiv=function(_CreateElementDiv9){_inherits(ProjectDiv,_CreateElementDiv9);function ProjectDiv(){_classCallCheck(this,ProjectDiv);return _possibleConstructorReturn(this,Object.getPrototypeOf(ProjectDiv).call(this));}_createClass(ProjectDiv,[{key:"fCreateProjDiv",value:function fCreateProjDiv(title,counter,appendedTo,divHeight,divWidth,divOverflow){_get(Object.getPrototypeOf(ProjectDiv.prototype),"fCreateDiv",this).call(this,title,counter,appendedTo);var divClass=$("."+title+"Class");//get class
fDivStyle(divClass,divHeight,divWidth,divOverflow,"grey");}}]);return ProjectDiv;}(CreateElementDiv);/**----------=====| ColumnDiv Class |=====----------**//** Description:
				 ** ColumnDiv class template is an extension of the CreateElementDiv class.
				 ** For creating column divs.
				 ***********************/var ColumnDiv=function(_CreateElementDiv10){_inherits(ColumnDiv,_CreateElementDiv10);function ColumnDiv(){_classCallCheck(this,ColumnDiv);return _possibleConstructorReturn(this,Object.getPrototypeOf(ColumnDiv).call(this));}_createClass(ColumnDiv,[{key:"fCreateColumnDiv",value:function fCreateColumnDiv(title,counter,appendedTo,divHeight,divWidth,divOverflow){_get(Object.getPrototypeOf(ColumnDiv.prototype),"fCreateDiv",this).call(this,title,counter,appendedTo);var divClass=$("."+title+"Class");//get class
var divNameId=$("#"+title+counter);//get id
fDivStyle(divNameId,divHeight,divWidth,divOverflow,"black");//DELETE COLOR
//divClass.css({"height": "250px"}); //testing
}}]);return ColumnDiv;}(CreateElementDiv);/**----------=====| ImgDiv Class |=====----------**//** Description:
				 ...
				 ** of the CreateElementDiv class.
				 ** For creating image divs.
				 **----------------------------------------------**/var ImgDiv=function(_CreateElementDiv11){_inherits(ImgDiv,_CreateElementDiv11);function ImgDiv(){_classCallCheck(this,ImgDiv);return _possibleConstructorReturn(this,Object.getPrototypeOf(ImgDiv).call(this));}_createClass(ImgDiv,[{key:"fCreateImgDiv",value:function fCreateImgDiv(title,counter,appendedTo,imgSrc,divHeight,divWidth,divOverflow){_get(Object.getPrototypeOf(ImgDiv.prototype),"fCreateDiv",this).call(this,title,counter,appendedTo);//let divClass = $ ("." + title + "Class"); //get class
/** getting the div id name has to follow the same convention
						 ** as it was set on the parent class.
						 ** this.divName.id        = title + "Id_" + counter; //set id name
						 ** let divNameId = $ ("#" + title + "Id_" + counter); //get id name
...
fImgDivStyle(divNameId,imgSrc,divHeight,divWidth,divOverflow);}}]);return ImgDiv;}(CreateElementDiv);/**----------=====| TextContent Class |=====----------**//** Description:
				 ** TextContent class template is an extension
				 ** of the CreateElementDiv class.
				 ** For creating innerHTML divs. ************//**------------**/var TextContent=function(_CreateElementDiv12){_inherits(TextContent,_CreateElementDiv12);function TextContent(){_classCallCheck(this,TextContent);return _possibleConstructorReturn(this,Object.getPrototypeOf(TextContent).call(this));}_createClass(TextContent,[{key:"fCreateSimpleTextDiv",value:function fCreateSimpleTextDiv(name,counter,appendedTo,textString){_get(Object.getPrototypeOf(TextContent.prototype),"fCreateDiv",this).call(this,name,counter,appendedTo);this.divName.innerHTML=textString;}},{key:"fCreateTextDiv",value:function fCreateTextDiv(name,counter,nameClass,appendedTo,textString,titleString){_get(Object.getPrototypeOf(TextContent.prototype),"fCreateDiv",this).call(this,name,counter,appendedTo);//this.nameName = document.createElement("div");
//this.nameName.id = nameId + counter; //set id // name + "Id_" + counter;
this.divName.className=nameClass;//set className
//let nameNameId     = $ ("#" + name + "Id_" + counter); //get id
//$(this.nameName).appendTo(appendedTo);
...
// `);
var codingThisSiteId=void 0;var logoContainerDivId=void 0;var logoLeftColDivId=void 0;var logoRightColDivId=void 0;var logoTitleColumnPercent=void 0;var logoTitleClass=void 0;var logoSubTitleClass=void 0;var logoTitleId=void 0;var logoSubTitleId=void 0;var introCalloutId=void 0;var toggleBtn=void 0;//let codingThisSiteId;
var introImageIds=void 0;var myIntroImage=void 0;var introBackgroungImage=void 0;var rightColumnHeight=void 0;var randColorTheme=void 0;var fIntroAjax=function fIntroAjax(){var promise=$.get("./js/json/introImages.json");promise.then(function(data){var jx=0;var _iteratorNormalCompletion9=true;var _didIteratorError9=false;var _iteratorError9=undefined;try{for(var _iterator9=data.GDSiteIntro[Symbol.iterator](),_step9;!(_iteratorNormalCompletion9=(_step9=_iterator9.next()).done);_iteratorNormalCompletion9=true){var introData=_step9.value;/**----------===| CREATE CODING CONTAINER DIV INSIDE INTROCONTAINER |===----------**/createDiv.fCreateBasicElement(introData.title+"_CodingContainer",jx,"codingContainer",introContainer);var codingContainerId=$("#"+introData.title+"_CodingContainer"+jx);//GET ID
/**----------===| CREATE CODING TEXT DIV INSIDE CODINGCONTAINER |===----------**/createDiv.fCreateBasicElement(introData.title+"_CodingThisSite",jx,"codingThisSite",codingContainerId);codingThisSiteId=$("#"+introData.title+"_CodingThisSite"+jx);//GET ID
var codingThisSite=$(".codingThisSite");//GET CLASSNAME
var codingThisSiteHeight=codingThisSiteId.height();fBasicDivStyle(codingThisSiteId,"auto",gdContainerWidth,"absolute");//CSS
var centerOnScreenY=inWindowHeight/2-codingThisSiteHeight/2;codingThisSiteId.css({"margin-top":centerOnScreenY});/**----------===| CREATE CODING PARAGRAPHS |===----------**/textDiv.fCreateTextDiv("codingTitle",jx,"codingTitleClass",codingThisSiteId,introData.codingTitle);textDiv.fCreateTextDiv("codingDescription",jx,"codingDescriptionClass",codingThisSiteId,introData.codingThisSite);/**----------===| CREATE LOGO CONTAINER DIV INSIDE INTROCONTAINER DIV |===----------**/createDiv.fCreateBasicElement(introData.title+"_LogoContainer",jx,"logoContainer",introContainer);logoContainerDivId=$("#"+introData.title+"_LogoContainer"+jx);//GET ID
...
// let inWindowWidth = window.innerWidth;
// let inWindowHeight = window.innerHeight;
fIntroImageStyle(introImageIds,inWindowHeight,inWindowWidth,myIntroImage.src);}}catch(err){_didIteratorError9=true;_iteratorError9=err;}finally{try{if(!_iteratorNormalCompletion9&&_iterator9.return){_iterator9.return();}}finally{if(_didIteratorError9){throw _iteratorError9;}}}});};/**----------===| INVOKE FUNCTION |===----------**///fIntroAjax();
//let logoContainer = $(".logoContainer");
// function toggleClass() {
//   //$("." + divClass).toggle();
//   logoContainer.toggle();
...
//   fWindowOpen2(personalFreshLinkId, personalFreshLink);
//TEMP fScreenQueries();
var _iteratorNormalCompletion10=true;var _didIteratorError10=false;var _iteratorError10=undefined;try{for(var _iterator10=data.GDSite[Symbol.iterator](),_step10;!(_iteratorNormalCompletion10=(_step10=_iterator10.next()).done);_iteratorNormalCompletion10=true){var sect=_step10.value;j1++;console.log("Section j1: "+j1+" "+sect.title);// /**----------===| LINKS TO OPEM TO ANOTHER WINDOW |===----------**/
// let nycBikeFlashSample = $('#nycBikeFlashSample');
// fRollEvents(nycBikeFlashSample, "white");
//
// let akonFlashSample = $('#akonFlashSample');
...
// fWindowOpen2(akonFlashSample, "http://www.rlgonzales.com/Scroll/images/ANIMATIONS/Flash/Akon/");
aSectionsCount[aSectionsCount.length]=sect;//PUSH
/**----------===| INVOKE SECTION COLUMNS |===----------**/twoColumnsHeaderSection.fTwoColumnsQueries(gdContainerWidth,sect.headerRightColumnPercent,arbitraryNum,arbitraryNum);aSectionsRightColumnPercent[aSectionsRightColumnPercent.length]=sect.headerRightColumnPercent;/**----------===| CREATE SECTION HEADER CONTAINER |===----------------------------------------**/createDiv.fCreateBasicElement(sect.title,j1,"sectionHeaderClass",gdContainer);var sectDivIds=$("#"+sect.title+j1);fBasicDivStyle(sectDivIds,"auto",gdContainerWidth,"relative");aSectionHeaders[aSectionHeaders.length]=sectDivIds;/**----------===| CREATE SECTION HEADER DIVIDER |===----------------------------------------**/createDiv.fCreateBasicElement("sectDivider",j1,"sectionDividerClass",sectDivIds);var sectDividerIds=$("#"+"sectDivider"+j1);/**----------===| COLOR THEME: DIVIDER |===----------**/sectDividerIds.css({"background-color":randColorTheme});/**----------===| CREATE HEADER LEFT COLUMN |===------------------------------------------------------------**/createDiv.fCreateBasicElement(sect.title+"_Left",j1,"sectionHeaderLeftColmnClass",sectDivIds);var sectLeftIds=$("#"+sect.title+"_Left"+j1);fBasicDivStyle(sectLeftIds,arbitraryNum,twoColumnsHeaderSection.LeftColumn,"relative");aSectionHeadrLeftColmn[aSectionHeadrLeftColmn.length]=sectLeftIds;/**----------===| CREATE HEADER RIGHT COLUMN |===-------------------------------------------------------------**/createDiv.fCreateBasicElement(sect.title+"_Right",j1,"sectionHeaderRightColmnClass",sectDivIds);var sectRightIds=$("#"+sect.title+"_Right"+j1);fBasicDivStyle(sectRightIds,"auto",twoColumnsHeaderSection.RightColumn,"relative");aSectionHeadrRightColmn[aSectionHeadrRightColmn.length]=sectRightIds;/**----------===| Sections Header Title Text |===----------**/sectionHeaderText.fBasicTextContent(sect.title+"_Text",j1,"sectionHeaderTxtContentClass",sectRightIds,sect.sectionTitle);var sectionTitleIds=$("#"+sect.title+"_Text"+j1);fBasicDivStyle(sectionTitleIds,"auto",twoColumnsHeaderSection.RightColumn,"relative");headerText.fTextQueries(gdContainerWidth,sectionTitleIds,headerSmlFontSize,headerMidFontSize,headerLrgFontSize);aSectionHeadrTitles[aSectionHeadrTitles.length]=sectionTitleIds;var _iteratorNormalCompletion11=true;var _didIteratorError11=false;var _iteratorError11=undefined;try{for(var _iterator11=sect.projects[Symbol.iterator](),_step11;!(_iteratorNormalCompletion11=(_step11=_iterator11.next()).done);_iteratorNormalCompletion11=true){var proj=_step11.value;j2++;console.log("\n\t\t\t              Project j2: "+j2+" "+proj.title);/**----------===| Divider tag for DOM and style inspection in the browser dev view for testing |===----------**/tagElement.fCreateTag("i","Divider:-------------------====•",proj.title,j2,gdContainer);/**----------===| PUSH TO ARRAY: PROJECT COUNT |===----------**/aProjectsCount[aProjectsCount.length]=proj;/**----------===| INVOKE PROJECT COLUMNS |===----------**/twoColumnsImgProjects.fTwoColumnsQueries(gdContainerWidth,proj.imgRightColumnPercent,proj.imagesWidth,proj.imagesHeight);/**----------===| PUSH TO ARRAY: PROJECT RIGHT COLUMNS |===----------**/aProjectRightColumnPercent[aProjectRightColumnPercent.length]=proj.imgRightColumnPercent;aImagesOrigWidth[aImagesOrigWidth.length]=proj.imagesWidth;aImagesOrigHeight[aImagesOrigHeight.length]=proj.imagesHeight;/**----------===| CREATE PROJECT IMAGE CONTAINER |===----------**/createDiv.fCreateBasicElement(proj.title+"_ProjContainer",j2,"projectContainerClass",gdContainer);/**----------===| Project Container Ids |===----------**/var projContainerIds=$("#"+proj.title+"_ProjContainer"+j2);/**p----------===| Project Container: Basic Style |===----------**/fBasicDivStyle(projContainerIds,"auto",gdContainerWidth);// ID, HEIGHT, WID, "relative"TH
/**----------===| push to array use for animation |===----------**/aProjContainerIds[aProjContainerIds.length]=projContainerIds;/**----------===| CREATE PROJECT IMAGE CONTAINER: LEFT COLUMN |===----------**/createDiv.fCreateBasicElement(proj.title+"_Left",j2,"projectLeftColmnClass",projContainerIds);/**----------===| Left Column Ids |===----------**/var projContainrLeftColDivIds=$("#"+proj.title+"_Left"+j2);/**p----------===| Left Column: Basic Style |===----------**/fBasicDivStyle(projContainrLeftColDivIds,arbitraryNum,twoColumnsImgProjects.LeftColumn);// other css properties: ".projectLeftColmnClass" in css fil, "relative"e.
/**----------===| push to array |===----------**/aProjLeftColDivIds[aProjLeftColDivIds.length]=projContainrLeftColDivIds;/**----------===| CREATE PROJECT IMAGE CONTAINER: RIGHT COLUMN |===----------**//** function parameters:(Id, Class, appendTo)
									 **--------------------------------------------------------------------**/createDiv.fCreateBasicElement(proj.title+"_ProjRight",j2,"projectRightColmnClass",projContainerIds);/**----------===| Right Column: Ids |===----------**/var projRightColDivIds=$("#"+proj.title+"_ProjRight"+j2);/**----------===| Right Column: Basic CSS |===----------------------------------**/fBasicDivStyle(projRightColDivIds,twoColumnsImgProjects.NewHeight+additionalHeight,twoColumnsImgProjects.RightColumn,"relative");aProjRightColDivIds[aProjRightColDivIds.length]=projRightColDivIds;//push
aProjectDisplay[aProjectDisplay.length]=proj.displayType;//push
...
// /**|===============================|**/
// `);
var _iteratorNormalCompletion12=true;var _didIteratorError12=false;var _iteratorError12=undefined;try{for(var _iterator12=proj.images[Symbol.iterator](),_step12;!(_iteratorNormalCompletion12=(_step12=_iterator12.next()).done);_iteratorNormalCompletion12=true){var imgs=_step12.value;j3++;// console.log(`
//   <•----------------------------------•>
//   aImagesCount.length:j3 :  ${aImagesCount.length}
//   ${imgs.imgTitle}
//   <•----------------------------------•>
...
var screenHeight=imgs.scrnHeight;var screenWidth=imgs.scrnWidth;fWindowOpen2(imageDescriptIds,linkToOpen,fullScreen,screenHeight,screenWidth);}else{/**----------===| J3: VIDEO ONLY  |===----------**//**----------===| push to array |===----------**/aVideoColumnPercent[aVideoColumnPercent.length]=proj.imgRightColumnPercent;/**----------===| FLUID-CONTAINER: CSS: VIDEO |===----------**/fBasicDivStyle(fluidContainerIds,twoColumnsImgProjects.NewHeight,twoColumnsImgProjects.RightColumn,"relative");/**----------===| CREATE YOUTUBE VIDEO PLACEHOLDER  |===----------**///instanceName.fCreateVideoDiv(videoId, appendedTo, divHeight, divWidth)
youTubeVideo.fCreateVideoDiv("video-placeholder",fluidContainerIds,twoColumnsImgProjects.NewHeight,twoColumnsImgProjects.RightColumn);var videoPlaceholder=$("#video-placeholder");/**----------===| videoPlaceholder: Height & Width CSS |===----------**/fBasicDivStyle(videoPlaceholder,twoColumnsImgProjects.NewHeight,twoColumnsImgProjects.RightColumn,"relative");}//END VIDEO
}}catch(err){_didIteratorError12=true;_iteratorError12=err;}finally{try{if(!_iteratorNormalCompletion12&&_iterator12.return){_iterator12.return();}}finally{if(_didIteratorError12){throw _iteratorError12;}}}}}catch(err){_didIteratorError11=true;_iteratorError11=err;}finally{try{if(!_iteratorNormalCompletion11&&_iterator11.return){_iterator11.return();}}finally{if(_didIteratorError11){throw _iteratorError11;}}}}}catch(err){_didIteratorError10=true;_iteratorError10=err;}finally{try{if(!_iteratorNormalCompletion10&&_iterator10.return){_iterator10.return();}}finally{if(_didIteratorError10){throw _iteratorError10;}}}console.log("--------------------| AJAX • END •  JSON |--------------------");});// End Promise
/** promise failure **/// function(data) {
//   console.log("Request Failed!")
// }
};/**----------===| INVOKE fRunAjax  |===----------**/fRunAjax();// console.log(`
...
// this.ImgContainerWidth; // = imgContainerWidth;
// this.fluidContainerWidth = fluidContainerWidth;
}_createClass(NextPrevNavClass,[{key:"fNextPrevNavigation",value:function fNextPrevNavigation(rightArrow,leftArrow,imgContainer,imgContainerWidth,fluidContainerWidth){var _this18=this;//}, rightColumnPercentage, imgOrigWidth, imgOrigHeight) {
this.String="Hello from fNextPreviousTwoColumnsClass method";this.RightArrow=rightArrow;this.LeftArrow=leftArrow;this.ImgContainer=imgContainer;this.ImgContainerWidth=imgContainerWidth;this.fluidContainerWidth=fluidContainerWidth;this.Num=0;var num=0;var containerXPos=0;this.fluidContainerLeftPosition=0;var fluidContainerLeftPosition=void 0;/**-----------=====| Next button function |=====-----------**/rightArrow.click(function(){num++;_this18.Num=num;containerXPos=_this18.ImgContainerWidth*num;leftArrow.show();// console.log(`
//     np:${imgContainer}-----------------------------------------
//     image width:                    ${this.ImgContainerWidth}
//     multiplied by numbr of clicks:  ${num}
//                                     ------------------
...
//     this.Num: same as clicks        ${this.Num}
//     np:---------------------------------------------------`)
/**-----| If the current x position greater or equals to the fluid-container width |-----**/_this18.fluidContainerLeftPosition=_this18.fluidContainerWidth-_this18.ImgContainerWidth*2;if(containerXPos>=_this18.fluidContainerLeftPosition){rightArrow.hide();}/**-----| fXSlider: Slides the image container to the left |-----**/anim.fXSlider(imgContainer,-containerXPos);//console.log(rightArrow, num, ":np---------------------------------------------------");
});/**-----------=====| Previous button function |=====-----------**/leftArrow.click(function(){num--;_this18.Num=num;containerXPos=_this18.ImgContainerWidth*num;rightArrow.show();// console.log(`
//     image width:                    ${this.ImgContainerWidth}
//     multiplied by numbr of clicks:  ${num}
//                                     ------------------
//     container x position:           ${containerXPos}
...
/******/__webpack_require__.c=installedModules;/******/// __webpack_public_path__
/******/__webpack_require__.p="";/******/// Load entry module and return exports
/******/return __webpack_require__(0);/******/})(/************************************************************************//******/[/* 0 *//***/function(module,exports,__webpack_require__){__webpack_require__(1);__webpack_require__(1);(function webpackMissingModule(){throw new Error("Cannot find module \"./js/webpacked/index.es6\"");})();/***/},/* 1 *//***/function(module,exports,__webpack_require__){/***********************************************
				 * Project: Jill Tucker Nursing Services
				 * Developer: rolandolloyd@gmail.com
				 * Copyright © 2015 GonzalesDesign
				 * Platform: NodeJS, ES6, Webpack, Babel & Node-Sass
...
//let titleNameId     = $ ("#" + title + "Id_" + counter); //get id
$(this.titleName).appendTo(appendedTo);//fDivStyle(divClass, divHeight, divWidth, divOverflow, "grey");
}}]);return CreateBasicElement;}();var BasicTextContent=function(_CreateBasicElement4){_inherits(BasicTextContent,_CreateBasicElement4);function BasicTextContent(){_classCallCheck(this,BasicTextContent);return _possibleConstructorReturn(this,Object.getPrototypeOf(BasicTextContent).call(this));}_createClass(BasicTextContent,[{key:"fBasicTextContent",value:function fBasicTextContent(titleId,counter,titleClass,appendedTo,textString){_get(Object.getPrototypeOf(BasicTextContent.prototype),"fCreateBasicElement",this).call(this,titleId,counter,titleClass,appendedTo);this.titleName.innerHTML=textString;}}]);return BasicTextContent;}(CreateBasicElement);/**------------=====| fBasicDivStyle CSS |=====------------*, "relative"*/var fBasicDivStyle=function fBasicDivStyle(divName,divHeight,divWidth,divPosition){//console.log("divName: ", divName);
divName.css({"width":divWidth,"height":divHeight,"position":divPosition,//relative absolute
"float":"left"//"overflow": divOverflow, //hidden; visible
//"border": "0px solid red" //+ borderColor
//"border-bottom" : "10px solid",
...
var imageBasicDiv=new CreateBasicElement();/**------------=====| End CreateBasicElement Class |=====------------**//**----------=====| ProjectDiv Class |=====----------**//** Description:
					 ** ProjectDiv class template is an extension of the CreateElementDiv class.
					 ** For creating project container divs.
					 ***********************/var ProjectDiv=function(_CreateElementDiv13){_inherits(ProjectDiv,_CreateElementDiv13);function ProjectDiv(){_classCallCheck(this,ProjectDiv);return _possibleConstructorReturn(this,Object.getPrototypeOf(ProjectDiv).call(this));}_createClass(ProjectDiv,[{key:"fCreateProjDiv",value:function fCreateProjDiv(title,counter,appendedTo,divHeight,divWidth,divOverflow){_get(Object.getPrototypeOf(ProjectDiv.prototype),"fCreateDiv",this).call(this,title,counter,appendedTo);var divClass=$("."+title+"Class");//get class
fDivStyle(divClass,divHeight,divWidth,divOverflow,"grey");}}]);return ProjectDiv;}(CreateElementDiv);/**----------=====| ColumnDiv Class |=====----------**//** Description:
					 ** ColumnDiv class template is an extension of the CreateElementDiv class.
					 ** For creating column divs.
					 ***********************/var ColumnDiv=function(_CreateElementDiv14){_inherits(ColumnDiv,_CreateElementDiv14);function ColumnDiv(){_classCallCheck(this,ColumnDiv);return _possibleConstructorReturn(this,Object.getPrototypeOf(ColumnDiv).call(this));}_createClass(ColumnDiv,[{key:"fCreateColumnDiv",value:function fCreateColumnDiv(title,counter,appendedTo,divHeight,divWidth,divOverflow){_get(Object.getPrototypeOf(ColumnDiv.prototype),"fCreateDiv",this).call(this,title,counter,appendedTo);var divClass=$("."+title+"Class");//get class
var divNameId=$("#"+title+counter);//get id
fDivStyle(divNameId,divHeight,divWidth,divOverflow,"black");//DELETE COLOR
//divClass.css({"height": "250px"}); //testing
}}]);return ColumnDiv;}(CreateElementDiv);/**----------=====| ImgDiv Class |=====----------**//** Description:
					 ...
					 ** of the CreateElementDiv class.
					 ** For creating image divs.
					 **----------------------------------------------**/var ImgDiv=function(_CreateElementDiv15){_inherits(ImgDiv,_CreateElementDiv15);function ImgDiv(){_classCallCheck(this,ImgDiv);return _possibleConstructorReturn(this,Object.getPrototypeOf(ImgDiv).call(this));}_createClass(ImgDiv,[{key:"fCreateImgDiv",value:function fCreateImgDiv(title,counter,appendedTo,imgSrc,divHeight,divWidth,divOverflow){_get(Object.getPrototypeOf(ImgDiv.prototype),"fCreateDiv",this).call(this,title,counter,appendedTo);//let divClass = $ ("." + title + "Class"); //get class
/** getting the div id name has to follow the same convention
							 ** as it was set on the parent class.
							 ** this.divName.id        = title + "Id_" + counter; //set id name
							 ** let divNameId = $ ("#" + title + "Id_" + counter); //get id name
...
fImgDivStyle(divNameId,imgSrc,divHeight,divWidth,divOverflow);}}]);return ImgDiv;}(CreateElementDiv);/**----------=====| TextContent Class |=====----------**//** Description:
					 ** TextContent class template is an extension
					 ** of the CreateElementDiv class.
					 ** For creating innerHTML divs. ************//**------------**/var TextContent=function(_CreateElementDiv16){_inherits(TextContent,_CreateElementDiv16);function TextContent(){_classCallCheck(this,TextContent);return _possibleConstructorReturn(this,Object.getPrototypeOf(TextContent).call(this));}_createClass(TextContent,[{key:"fCreateSimpleTextDiv",value:function fCreateSimpleTextDiv(name,counter,appendedTo,textString){_get(Object.getPrototypeOf(TextContent.prototype),"fCreateDiv",this).call(this,name,counter,appendedTo);this.divName.innerHTML=textString;}},{key:"fCreateTextDiv",value:function fCreateTextDiv(name,counter,nameClass,appendedTo,textString,titleString){_get(Object.getPrototypeOf(TextContent.prototype),"fCreateDiv",this).call(this,name,counter,appendedTo);//this.nameName = document.createElement("div");
//this.nameName.id = nameId + counter; //set id // name + "Id_" + counter;
this.divName.className=nameClass;//set className
//let nameNameId     = $ ("#" + name + "Id_" + counter); //get id
//$(this.nameName).appendTo(appendedTo);
...
// `);
var codingThisSiteId=void 0;var logoContainerDivId=void 0;var logoLeftColDivId=void 0;var logoRightColDivId=void 0;var logoTitleColumnPercent=void 0;var logoTitleClass=void 0;var logoSubTitleClass=void 0;var logoTitleId=void 0;var logoSubTitleId=void 0;var introCalloutId=void 0;var toggleBtn=void 0;//let codingThisSiteId;
var introImageIds=void 0;var myIntroImage=void 0;var introBackgroungImage=void 0;var rightColumnHeight=void 0;var randColorTheme=void 0;var fIntroAjax=function fIntroAjax(){var promise=$.get("./js/json/introImages.json");promise.then(function(data){var jx=0;var _iteratorNormalCompletion13=true;var _didIteratorError13=false;var _iteratorError13=undefined;try{for(var _iterator13=data.GDSiteIntro[Symbol.iterator](),_step13;!(_iteratorNormalCompletion13=(_step13=_iterator13.next()).done);_iteratorNormalCompletion13=true){var introData=_step13.value;/**----------===| CREATE CODING CONTAINER DIV INSIDE INTROCONTAINER |===----------**/createDiv.fCreateBasicElement(introData.title+"_CodingContainer",jx,"codingContainer",introContainer);var codingContainerId=$("#"+introData.title+"_CodingContainer"+jx);//GET ID
/**----------===| CREATE CODING TEXT DIV INSIDE CODINGCONTAINER |===----------**/createDiv.fCreateBasicElement(introData.title+"_CodingThisSite",jx,"codingThisSite",codingContainerId);codingThisSiteId=$("#"+introData.title+"_CodingThisSite"+jx);//GET ID
var codingThisSite=$(".codingThisSite");//GET CLASSNAME
var codingThisSiteHeight=codingThisSiteId.height();fBasicDivStyle(codingThisSiteId,"auto",gdContainerWidth,"absolute");//CSS
var centerOnScreenY=inWindowHeight/2-codingThisSiteHeight/2;codingThisSiteId.css({"margin-top":centerOnScreenY});/**----------===| CREATE CODING PARAGRAPHS |===----------**/textDiv.fCreateTextDiv("codingTitle",jx,"codingTitleClass",codingThisSiteId,introData.codingTitle);textDiv.fCreateTextDiv("codingDescription",jx,"codingDescriptionClass",codingThisSiteId,introData.codingThisSite);/**----------===| CREATE LOGO CONTAINER DIV INSIDE INTROCONTAINER DIV |===----------**/createDiv.fCreateBasicElement(introData.title+"_LogoContainer",jx,"logoContainer",introContainer);logoContainerDivId=$("#"+introData.title+"_LogoContainer"+jx);//GET ID
...
// let inWindowWidth = window.innerWidth;
// let inWindowHeight = window.innerHeight;
fIntroImageStyle(introImageIds,inWindowHeight,inWindowWidth,myIntroImage.src);}}catch(err){_didIteratorError13=true;_iteratorError13=err;}finally{try{if(!_iteratorNormalCompletion13&&_iterator13.return){_iterator13.return();}}finally{if(_didIteratorError13){throw _iteratorError13;}}}});};/**----------===| INVOKE FUNCTION |===----------**///fIntroAjax();
//let logoContainer = $(".logoContainer");
// function toggleClass() {
//   //$("." + divClass).toggle();
//   logoContainer.toggle();
...
//   fWindowOpen2(personalFreshLinkId, personalFreshLink);
//TEMP fScreenQueries();
var _iteratorNormalCompletion14=true;var _didIteratorError14=false;var _iteratorError14=undefined;try{for(var _iterator14=data.GDSite[Symbol.iterator](),_step14;!(_iteratorNormalCompletion14=(_step14=_iterator14.next()).done);_iteratorNormalCompletion14=true){var sect=_step14.value;j1++;console.log("Section j1: "+j1+" "+sect.title);// /**----------===| LINKS TO OPEM TO ANOTHER WINDOW |===----------**/
// let nycBikeFlashSample = $('#nycBikeFlashSample');
// fRollEvents(nycBikeFlashSample, "white");
//
// let akonFlashSample = $('#akonFlashSample');
...
// fWindowOpen2(akonFlashSample, "http://www.rlgonzales.com/Scroll/images/ANIMATIONS/Flash/Akon/");
aSectionsCount[aSectionsCount.length]=sect;//PUSH
/**----------===| INVOKE SECTION COLUMNS |===----------**/twoColumnsHeaderSection.fTwoColumnsQueries(gdContainerWidth,sect.headerRightColumnPercent,arbitraryNum,arbitraryNum);aSectionsRightColumnPercent[aSectionsRightColumnPercent.length]=sect.headerRightColumnPercent;/**----------===| CREATE SECTION HEADER CONTAINER |===----------------------------------------**/createDiv.fCreateBasicElement(sect.title,j1,"sectionHeaderClass",gdContainer);var sectDivIds=$("#"+sect.title+j1);fBasicDivStyle(sectDivIds,"auto",gdContainerWidth,"relative");aSectionHeaders[aSectionHeaders.length]=sectDivIds;/**----------===| CREATE SECTION HEADER DIVIDER |===----------------------------------------**/createDiv.fCreateBasicElement("sectDivider",j1,"sectionDividerClass",sectDivIds);var sectDividerIds=$("#"+"sectDivider"+j1);/**----------===| COLOR THEME: DIVIDER |===----------**/sectDividerIds.css({"background-color":randColorTheme});/**----------===| CREATE HEADER LEFT COLUMN |===------------------------------------------------------------**/createDiv.fCreateBasicElement(sect.title+"_Left",j1,"sectionHeaderLeftColmnClass",sectDivIds);var sectLeftIds=$("#"+sect.title+"_Left"+j1);fBasicDivStyle(sectLeftIds,arbitraryNum,twoColumnsHeaderSection.LeftColumn,"relative");aSectionHeadrLeftColmn[aSectionHeadrLeftColmn.length]=sectLeftIds;/**----------===| CREATE HEADER RIGHT COLUMN |===-------------------------------------------------------------**/createDiv.fCreateBasicElement(sect.title+"_Right",j1,"sectionHeaderRightColmnClass",sectDivIds);var sectRightIds=$("#"+sect.title+"_Right"+j1);fBasicDivStyle(sectRightIds,"auto",twoColumnsHeaderSection.RightColumn,"relative");aSectionHeadrRightColmn[aSectionHeadrRightColmn.length]=sectRightIds;/**----------===| Sections Header Title Text |===----------**/sectionHeaderText.fBasicTextContent(sect.title+"_Text",j1,"sectionHeaderTxtContentClass",sectRightIds,sect.sectionTitle);var sectionTitleIds=$("#"+sect.title+"_Text"+j1);fBasicDivStyle(sectionTitleIds,"auto",twoColumnsHeaderSection.RightColumn,"relative");headerText.fTextQueries(gdContainerWidth,sectionTitleIds,headerSmlFontSize,headerMidFontSize,headerLrgFontSize);aSectionHeadrTitles[aSectionHeadrTitles.length]=sectionTitleIds;var _iteratorNormalCompletion15=true;var _didIteratorError15=false;var _iteratorError15=undefined;try{for(var _iterator15=sect.projects[Symbol.iterator](),_step15;!(_iteratorNormalCompletion15=(_step15=_iterator15.next()).done);_iteratorNormalCompletion15=true){var proj=_step15.value;j2++;console.log("\n\t\t\t\t              Project j2: "+j2+" "+proj.title);/**----------===| Divider tag for DOM and style inspection in the browser dev view for testing |===----------**/tagElement.fCreateTag("i","Divider:-------------------====•",proj.title,j2,gdContainer);/**----------===| PUSH TO ARRAY: PROJECT COUNT |===----------**/aProjectsCount[aProjectsCount.length]=proj;/**----------===| INVOKE PROJECT COLUMNS |===----------**/twoColumnsImgProjects.fTwoColumnsQueries(gdContainerWidth,proj.imgRightColumnPercent,proj.imagesWidth,proj.imagesHeight);/**----------===| PUSH TO ARRAY: PROJECT RIGHT COLUMNS |===----------**/aProjectRightColumnPercent[aProjectRightColumnPercent.length]=proj.imgRightColumnPercent;aImagesOrigWidth[aImagesOrigWidth.length]=proj.imagesWidth;aImagesOrigHeight[aImagesOrigHeight.length]=proj.imagesHeight;/**----------===| CREATE PROJECT IMAGE CONTAINER |===----------**/createDiv.fCreateBasicElement(proj.title+"_ProjContainer",j2,"projectContainerClass",gdContainer);/**----------===| Project Container Ids |===----------**/var projContainerIds=$("#"+proj.title+"_ProjContainer"+j2);/**p----------===| Project Container: Basic Style |===----------**/fBasicDivStyle(projContainerIds,"auto",gdContainerWidth);// ID, HEIGHT, WID, "relative"TH
/**----------===| push to array use for animation |===----------**/aProjContainerIds[aProjContainerIds.length]=projContainerIds;/**----------===| CREATE PROJECT IMAGE CONTAINER: LEFT COLUMN |===----------**/createDiv.fCreateBasicElement(proj.title+"_Left",j2,"projectLeftColmnClass",projContainerIds);/**----------===| Left Column Ids |===----------**/var projContainrLeftColDivIds=$("#"+proj.title+"_Left"+j2);/**p----------===| Left Column: Basic Style |===----------**/fBasicDivStyle(projContainrLeftColDivIds,arbitraryNum,twoColumnsImgProjects.LeftColumn);// other css properties: ".projectLeftColmnClass" in css fil, "relative"e.
/**----------===| push to array |===----------**/aProjLeftColDivIds[aProjLeftColDivIds.length]=projContainrLeftColDivIds;/**----------===| CREATE PROJECT IMAGE CONTAINER: RIGHT COLUMN |===----------**//** function parameters:(Id, Class, appendTo)
										 **--------------------------------------------------------------------**/createDiv.fCreateBasicElement(proj.title+"_ProjRight",j2,"projectRightColmnClass",projContainerIds);/**----------===| Right Column: Ids |===----------**/var projRightColDivIds=$("#"+proj.title+"_ProjRight"+j2);/**----------===| Right Column: Basic CSS |===----------------------------------**/fBasicDivStyle(projRightColDivIds,twoColumnsImgProjects.NewHeight+additionalHeight,twoColumnsImgProjects.RightColumn,"relative");aProjRightColDivIds[aProjRightColDivIds.length]=projRightColDivIds;//push
aProjectDisplay[aProjectDisplay.length]=proj.displayType;//push
...
// /**|===============================|**/
// `);
var _iteratorNormalCompletion16=true;var _didIteratorError16=false;var _iteratorError16=undefined;try{for(var _iterator16=proj.images[Symbol.iterator](),_step16;!(_iteratorNormalCompletion16=(_step16=_iterator16.next()).done);_iteratorNormalCompletion16=true){var imgs=_step16.value;j3++;// console.log(`
//   <•----------------------------------•>
//   aImagesCount.length:j3 :  ${aImagesCount.length}
//   ${imgs.imgTitle}
//   <•----------------------------------•>
...
var screenHeight=imgs.scrnHeight;var screenWidth=imgs.scrnWidth;fWindowOpen2(imageDescriptIds,linkToOpen,fullScreen,screenHeight,screenWidth);}else{/**----------===| J3: VIDEO ONLY  |===----------**//**----------===| push to array |===----------**/aVideoColumnPercent[aVideoColumnPercent.length]=proj.imgRightColumnPercent;/**----------===| FLUID-CONTAINER: CSS: VIDEO |===----------**/fBasicDivStyle(fluidContainerIds,twoColumnsImgProjects.NewHeight,twoColumnsImgProjects.RightColumn,"relative");/**----------===| CREATE YOUTUBE VIDEO PLACEHOLDER  |===----------**///instanceName.fCreateVideoDiv(videoId, appendedTo, divHeight, divWidth)
youTubeVideo.fCreateVideoDiv("video-placeholder",fluidContainerIds,twoColumnsImgProjects.NewHeight,twoColumnsImgProjects.RightColumn);var videoPlaceholder=$("#video-placeholder");/**----------===| videoPlaceholder: Height & Width CSS |===----------**/fBasicDivStyle(videoPlaceholder,twoColumnsImgProjects.NewHeight,twoColumnsImgProjects.RightColumn,"relative");}//END VIDEO
}}catch(err){_didIteratorError16=true;_iteratorError16=err;}finally{try{if(!_iteratorNormalCompletion16&&_iterator16.return){_iterator16.return();}}finally{if(_didIteratorError16){throw _iteratorError16;}}}}}catch(err){_didIteratorError15=true;_iteratorError15=err;}finally{try{if(!_iteratorNormalCompletion15&&_iterator15.return){_iterator15.return();}}finally{if(_didIteratorError15){throw _iteratorError15;}}}}}catch(err){_didIteratorError14=true;_iteratorError14=err;}finally{try{if(!_iteratorNormalCompletion14&&_iterator14.return){_iterator14.return();}}finally{if(_didIteratorError14){throw _iteratorError14;}}}console.log("--------------------| AJAX • END •  JSON |--------------------");});// End Promise
/** promise failure **/// function(data) {
//   console.log("Request Failed!")
// }
};/**----------===| INVOKE fRunAjax  |===----------**/fRunAjax();// console.log(`
...
// this.ImgContainerWidth; // = imgContainerWidth;
// this.fluidContainerWidth = fluidContainerWidth;
}_createClass(NextPrevNavClass,[{key:"fNextPrevNavigation",value:function fNextPrevNavigation(rightArrow,leftArrow,imgContainer,imgContainerWidth,fluidContainerWidth){var _this24=this;//}, rightColumnPercentage, imgOrigWidth, imgOrigHeight) {
this.String="Hello from fNextPreviousTwoColumnsClass method";this.RightArrow=rightArrow;this.LeftArrow=leftArrow;this.ImgContainer=imgContainer;this.ImgContainerWidth=imgContainerWidth;this.fluidContainerWidth=fluidContainerWidth;this.Num=0;var num=0;var containerXPos=0;this.fluidContainerLeftPosition=0;var fluidContainerLeftPosition=void 0;/**-----------=====| Next button function |=====-----------**/rightArrow.click(function(){num++;_this24.Num=num;containerXPos=_this24.ImgContainerWidth*num;leftArrow.show();// console.log(`
//     np:${imgContainer}-----------------------------------------
//     image width:                    ${this.ImgContainerWidth}
//     multiplied by numbr of clicks:  ${num}
//                                     ------------------
...
//     this.Num: same as clicks        ${this.Num}
//     np:---------------------------------------------------`)
/**-----| If the current x position greater or equals to the fluid-container width |-----**/_this24.fluidContainerLeftPosition=_this24.fluidContainerWidth-_this24.ImgContainerWidth*2;if(containerXPos>=_this24.fluidContainerLeftPosition){rightArrow.hide();}/**-----| fXSlider: Slides the image container to the left |-----**/anim.fXSlider(imgContainer,-containerXPos);//console.log(rightArrow, num, ":np---------------------------------------------------");
});/**-----------=====| Previous button function |=====-----------**/leftArrow.click(function(){num--;_this24.Num=num;containerXPos=_this24.ImgContainerWidth*num;rightArrow.show();// console.log(`
//     image width:                    ${this.ImgContainerWidth}
//     multiplied by numbr of clicks:  ${num}
//                                     ------------------
//     container x position:           ${containerXPos}
